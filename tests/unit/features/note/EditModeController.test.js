...
describe('EditModeController', () => {
  ...
  describe('Initialization', () => {
    it('should initialize only once', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('EditModeController: Initialized');
      
      // Try to initialize again
      editModeController.initialize();
      expect(warnSpy).toHaveBeenCalledWith('EditModeController: Already initialized');
    ...
    it('should set up event listeners on initialization', () => {
      ...
      expect(onSpy).toHaveBeenCalledWith('note.requestEdit', expect.any(Function));
      expect(onSpy).toHaveBeenCalledWith('note.requestView', expect.any(Function));
      expect(onSpy).toHaveBeenCalledWith('canvas.clicked', expect.any(Function));
  ...
  describe('Edit Mode Entry', () => {
    ...
    it('should enter edit mode when receiving requestEdit event', () => {
      ...
      expect(displayAsEditMode).toHaveBeenCalledWith(mockNoteContent, '# Test Content');
      expect(mockNote.contentEditable).toBe(true);
    });
    ...
    it('should exit current edit when editing different note', () => {
      ...
      expect(displayAsViewMode).toHaveBeenCalledWith(mockNoteContent, 'Content 1');
  ...
  describe('Edit Mode Exit', () => {
    ...
    it('should exit edit mode when receiving requestView event', () => {
      ...
      expect(displayAsViewMode).toHaveBeenCalledWith(mockNoteContent, 'Updated content');
  ...
  describe('Blur Handling', () => {
    ...
    it('should exit edit mode on blur after delay', (done) => {
      eventBus.emit('note.requestEdit', {
        noteId: 'note-123',
        noteElement: mockNote
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing note element gracefully', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('EditModeController: No note element provided');
      expect(editModeController.state).toBe('VIEW');
    ...
    it('should handle missing note content element', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith('EditModeController: No note content element found');
      expect(editModeController.state).toBe('VIEW');
