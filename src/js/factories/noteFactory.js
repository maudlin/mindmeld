...
export function createNoteAtPosition(canvas, event, addEventListeners = null) {
  console.warn('DEPRECATED: createNoteAtPosition() - Use NoteBehavior.createNoteAtPosition() instead. This factory approach will be removed in future versions for better ID collision prevention.');
...
export function createNote(x, y, canvas, addEventListeners = null) {
  console.warn('DEPRECATED: createNote() - Use NoteBehavior.createNote() instead. This factory approach will be removed in future versions for better ID collision prevention.');
